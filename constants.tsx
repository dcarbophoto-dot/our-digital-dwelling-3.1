...
export const OUTDOOR_STYLES: StagingOption[] = [
  ...
  },
  {
    ...
    prompt: 'Transform the season to peak Summer. Ensure trees and grass are natural looking green. The sun should be bright and the sky clear blue. Create a warm, inviting summer atmosphere. Preserve the house architecture.',
    category: 'outdoor',
    creditCost: 5
  },
  {
