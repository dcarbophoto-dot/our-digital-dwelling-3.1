          ...
          <div className="prose prose-slate dark:prose-invert prose-indigo max-w-none prose-headings:font-black prose-h3:text-indigo-600 dark:prose-h3:text-indigo-400 prose-img:rounded-3xl prose-a:font-bold">
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 my-8">
              ...
              <ul className="list-none pl-0 space-y-2 text-sm font-medium">
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Applied an appropriate watermark overlay directly onto the artwork</li>
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Confirmed the text remains readable at the final display resolution</li>
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Updated the individual photo caption to explicitly state the use of digital enhancements</li>
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Added a transparent disclosure statement directly into the public property description</li>
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Alerted fellow agents via the private agent-to-agent remarks section</li>
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Uploaded the raw, unedited source photos alongside the enhanced copies for comparison</li>
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Ensured no load-bearing walls, permanent fixtures, or architectural elements were digitally removed or added</li>
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Verified that pre-existing property damage, stains, or hazards remain fully visible</li>
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Confirmed the exterior views accurately reflect the real-world property vantage point</li>
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Reviewed your specific regional MLS bylaws governing digital manipulation</li>
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Double-checked any overarching state-level real estate commission mandates</li>
                <li className="flex items-center gap-2"><svg className="text-indigo-500 w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg> Consulted with your internal brokerage compliance team for final sign-off</li>
              </ul>
            </div>
